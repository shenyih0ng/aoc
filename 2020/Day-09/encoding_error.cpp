...
long int find_encrypt_weakness(ifstream& stream, long int target) {
        // Find a contigous range that sums to up target -> add smallest and
        // largest of that range
...
int main(int argc, char* argv[]) {
        ...
        if (input_stream.is_open()) {
                ...
                long int encryption_weakness =
                    find_encrypt_weakness(input_stream, invalid_num);
