...
bool validate_year (std::string value, int lower, int upper) { return (value.size() == 4) && validate_num(value, lower, upper); }

bool validate_byr (std::string value) { return validate_year(value, 1920, 2002); }
bool validate_iyr (std::string value) { return validate_year(value, 2010, 2020); }
bool validate_eyr (std::string value) { return validate_year(value, 2020, 2030); }
...
bool validate_ecl (std::string value) {
	const std::string eye_colors[] = {"amb", "blu", "brn", "gry", "grn", "hzl", "oth"};
